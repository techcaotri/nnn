...
#define ICON_DATABASE      ICON_STR(MFIZZ_DATABASE_ALT2, "󰆼", "💾")
#define ICON_DESKTOP       ICON_STR(FA_DESKTOP, "󰟀", "💻")
...
#define ICON_LICENSE       ICON_STR(FA_COPYRIGHT, "󰈙", "📑")
...
#define ICON_PHOTOSHOP     ICON_STR(DEV_PHOTOSHOP, "", "🎨")
#define ICON_PICTUREFILE   ICON_STR(FA_FILE_IMAGE_O, "󰈟", "📷")
